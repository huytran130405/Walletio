    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.formCard}>
          <Text style={styles.formTitle}>{editingId ? "Sửa nhóm" : "Thêm nhóm"}</Text>
          <TextInput
            style={styles.input}
            value={title}
          ...
          <TouchableOpacity style={styles.saveBtn} onPress={handleSave}>
            <Text style={styles.saveText}>{editingId ? "Lưu nhóm" : "Thêm nhóm"}</Text>
          </TouchableOpacity>
        </View>
        ...
        {groups.map((group) => (
          ...
          >
            ...
            <View style={styles.rowInfo}>
              ...
              <Text style={styles.rowMeta}>Nhấn để sửa · Nhấn giữ để xoá</Text>
            </View>
